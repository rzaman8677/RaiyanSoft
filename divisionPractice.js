$(document).ready(function() {
    ...
    var $minVal;
    var $maxVal;
    var $decimal = $('#decimalRounding');
    var $decimalVal;
    var $roundMessage = $('#roundingMessage');
    $change.click(function() {
        ...
        if($decimal.val() == '') {
            ...
            $decimalVal = ($decimal.val());
            $roundMessage.text("Rounding to " + $decimalVal + " decimal places.");
        }   
    ...
    $answer = round($answer, $decimalVal);
